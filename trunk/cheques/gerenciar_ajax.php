...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="46%">&nbsp;&nbsp;&nbsp;<img src="cheques/img/cheques.png" alt="Controle de Cheques"> <span class="h3">Controle de Cheques </span></td>
      ...
      <td width="23%" align="right" valign="bottom"><img src="../imagens/icones/novo.gif" alt="Incluir" width="19" height="22" border="0"><a href="javascript:Ajax('cheques/incluir', 'conteudo', '')">Incluir novo cheque </a></td>
