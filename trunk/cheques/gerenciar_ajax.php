...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      ...
      <td width="23%" align="right" valign="bottom"><img src="imagens/icones/novo.gif" alt="" width="19" height="22" border="0"><a href="javascript:Ajax('cheques/incluir', 'conteudo', '')"><?=$LANG['check_control']['include_new_check']?></a></td>
