	...
	if(isset($_POST[Salvar])) {	
		...
		if($j == 0) {
			...
			if($_GET[acao] != "editar") {
				...
				$strScrp = "alert('Cadastro realizado com sucesso!'); Ajax('patrimonio/gerenciar', 'conteudo', '');";
			}
			$patrimonio->Salvar();
		}
	}
...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="56%">&nbsp;&nbsp;&nbsp;<img src="patrimonio/img/patrimonio.png" alt="PATRIMÔNIO" title="PATRIMÔNIO"> <span class="h3">PATRIM&Ocirc;NIO [
      <?=$strLoCase?>] </span></td>
...
<div class="conteudo" id="table dados"><br>
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
    <tr>
      <td width="243" height="26"><?=$strUpCase?> DE PATRIM&Ocirc;NIO </td>
      <td width="381">&nbsp;</td>
    </tr>
  </table>
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela">
    <tr>
      ...
      <form id="form2" name="form2" method="POST" action="patrimonio/incluir_ajax.php<?=$frmActEdt?>" onsubmit="formSender(this, 'conteudo'); return false;"><fieldset>
        <legend><span class="style1">Informa&ccedil;&otilde;es do Patrim&ocirc;nio </span></legend>
