...
?>
    <tr bgcolor="#<?=$odev?>" onmouseout="style.background='#<?=$odev?>'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="15%" align="center"><input type="text" size="13" name="quantidade" id="quantidade" value="<?=$conta->RetornaDados('quantidade')?>" onblur="Ajax('estoque_dent/atualiza', 'conta_atualiza', 'codigo=<?=$conta->RetornaDados('codigo')?>&estoque='%2Bthis.value)"></td>
      <td width="10%" align="center"><a href="javascript:Ajax('estoque_dent/extrato', 'conteudo', 'codigo=<?=$conta->RetornaDados('codigo')?>" onclick="return confirmLink(this)"><img src="imagens/icones/excluir.gif" alt="Excluir" width="19" height="19" border="0"></a></td>
    </tr>
<?
	}
	if($odev == $impar) {
