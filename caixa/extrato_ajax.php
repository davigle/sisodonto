...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="35%">&nbsp;&nbsp;&nbsp;<img src="caixa/img/caixa.png" alt="Fluxo de Caixa da Clínica"> <span class="h3">Fluxo de Caixa da Clínica </span></td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="93%" align="right">
          <tr>
            ...
            <td width="40%" align="right">
        	  Pesquisar <input name="procurar" id="procurar" type="text" class="forms" size="20" maxlength="40" onkeyup="javascript:Ajax('caixa/pesquisa', 'pesquisa', 'pesquisa='%2Bthis.value%2B'&peri='%2Bdocument.getElementById('peri').value%2B'&cpf_dentista='%2Bdocument.getElementById('cpf_dentista').options[document.getElementById('cpf_dentista').selectedIndex].value)" onKeypress="return Ajusta_DMA(this, event, document.getElementById('peri').value);"
              onclick="if(document.getElementById('pesqdia').checked) {abreCalendario(this);}">
            </td>
          </tr>
          <tr>
            <td align="left">
              <input type="radio" name="pesq" id="pesqmesatual" value="mesatual" onclick="javascript:Ajax('caixa/pesquisa', 'pesquisa', 'peri=mesatual&cpf_dentista='%2Bdocument.getElementById('cpf_dentista').options[document.getElementById('cpf_dentista').selectedIndex].value)"><label for="pesqmesatual"> Mês atual</label>
            </td>
            <td colspan="3" align="right">
              Dentista:
              <select name="cpf_dentista" class="forms" id="cpf_dentista">
                <option value="0">Todos os lançamentos</option>
<?
		$dentista = new TDentistas();
		$lista = $dentista->ListDentistas("SELECT * FROM `dentistas` ORDER BY `nome` ASC");
