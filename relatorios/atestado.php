<?
    ...
    */
	...
	if(isset($_POST['send'])) {
        $atestado->Atestado = htmlspecialchars(trim($_POST['atestado']), ENT_QUOTES);
        $atestado->Salvar();
	}
...
?>
<br />
<div align="center"><font size="4"><b>A T E S T A D O</b></font></div><br /><br />
